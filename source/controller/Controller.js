sGis.module('spatialProcessor.Controller', [
...
], function(utils, spUtils, Point, Polyline, Polygon, parseXML, EventHandler, pointSymbols, polylineSymbols, polygonSymbols, MapService, LayerManager) {
    'use strict';
    ...
    let ext = {
        ...
        createObject: function(properties) {
            ...
            var attributes = properties.attributes ? '&attributes=' + JSON.stringify(properties.attributes) : '';
